...
class TestEPSGrowth:
    def test_consistent_growth(self):
        from analysis.fundamental import analyze_eps_growth
...
class TestROE:
    def test_high_roe(self):
        from analysis.fundamental import analyze_roe
...
class TestFCF:
    def test_strong_fcf(self):
        from analysis.fundamental import analyze_free_cash_flow
...
class TestBalanceSheet:
    def test_strong_balance(self):
        from analysis.fundamental import analyze_balance_sheet
...
class TestDividend:
    def test_pays_dividend(self):
        from analysis.fundamental import analyze_dividends
...
class TestDCF:
    def test_undervalued(self):
        from analysis.fundamental import calculate_dcf_intrinsic_value
        from analysis.fundamental import analyze_free_cash_flow
...
class TestRevenue:
    def test_growing_revenue(self):
        from analysis.fundamental import analyze_revenue_growth
